...
import com.study.andersen.gof.creational.builder.dog.DogManual;
...
public class DogManualBuilder implements Builder {
    ...
    public DogManual getResult() {
        String descriptions = "Breed: " + breed.name() +
                ", Weight: " + weight +
                ", Color: " + color +
                ", Behavior: " + behavior +
                ", Name:" + name;
        return new DogManual(descriptions);
    }
}
